...
/* package proofed-0.1.0.0 */
#ifndef VERSION_proofed
#define VERSION_proofed "0.1.0.0"
#endif /* VERSION_proofed */
#ifndef MIN_VERSION_proofed
#define MIN_VERSION_proofed(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_proofed */
...
#define CURRENT_COMPONENT_ID "proofed-0.1.0.0-inplace-proofed"
